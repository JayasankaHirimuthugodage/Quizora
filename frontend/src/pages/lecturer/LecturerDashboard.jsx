        ...
        <div className="bg-white overflow-hidden shadow-lg rounded-xl border border-gray-200">
          <div className="p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-gray-500">My Modules</p>
        ...
        <div className="bg-white overflow-hidden shadow-lg rounded-xl border border-gray-200">
          ...
          <div className="p-6">
            <div className="text-center py-8">
              ...
              <p className="text-xs text-gray-400">
                Create and schedule quizzes for your students
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white overflow-hidden shadow-lg rounded-xl border border-gray-200">
          ...
          <div className="p-6">
            <div className="text-center py-8">
              ...
              <p className="text-xs text-gray-400">
                Activity will be tracked once you start using the platform
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-start">
            ...
            <div className="ml-4 flex-1">
              <h3 className="text-lg font-semibold text-gray-900 mb-2">
                Getting Started with Quiz Management
              </h3>
              <p className="text-sm text-gray-600 mb-4">
                Welcome to Quizora! Create engaging assessments for your students with our comprehensive quiz management system:
              </p>
              <div className="space-y-2">
                <div className="flex items-center text-sm">
                  ...
                  <span className="text-gray-700">
                    Build your question bank by creating modules and adding questions
                  </span>
                </div>
                <div className="flex items-center text-sm">
                  <div className="w-6 h-6 bg-blue-100 rounded-full flex items-center justify-center mr-3">
                  ...
                  <span className="text-gray-700">
                    Schedule quizzes with specific date, time, and student eligibility criteria
                  </span>
                </div>
                <div className="flex items-center text-sm">
                  <div className="w-6 h-6 bg-blue-100 rounded-full flex items-center justify-center mr-3">
                  ...
                  <span className="text-gray-700">
                    Monitor quiz progress and review student submissions in real-time
                  </span>
                </div>
              </div>
            </div>
