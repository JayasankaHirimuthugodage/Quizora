        ...
        <div className="bg-white overflow-hidden shadow-lg rounded-xl border border-gray-200">
          ...
          <div className="p-6">
            <div className="text-center py-8">
              ...
              <p className="text-xs text-gray-400">
                Your schedule will appear here once courses are created
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-start">
            ...
            <div className="ml-4 flex-1">
              ...
              <p className="text-sm text-gray-600 mb-4">
                Welcome to Quizora! Here's how you can get started with managing
                your courses and assessments:
              </p>
              <div className="space-y-2">
                <div className="flex items-center text-sm">
                  ...
                  <span className="text-gray-700">
                    Build your question bank by module
                  </span>
                </div>
                <div className="flex items-center text-sm">
                  <div className="w-6 h-6 bg-blue-100 rounded-full flex items-center justify-center mr-3">
                  ...
                  <span className="text-gray-700">
                    Create engaging quizzes and assessments
                  </span>
                </div>
                <div className="flex items-center text-sm">
                  <div className="w-6 h-6 bg-blue-100 rounded-full flex items-center justify-center mr-3">
