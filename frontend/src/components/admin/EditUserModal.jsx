...
import { X, User, Mail, UserCheck, Eye, EyeOff, GraduationCap, Briefcase, Phone, MapPin, Calendar } from 'lucide-react';
...
const EditUserModal = ({ 
  ...
  const handleSubmit = async (e) => {
    ...
    await onUpdateUser(user._id, submitData);
  };
